...
fun main() {
    ...
    val correspondence1 = (WEIGHT_MIN_AVERAGE < weightCargo2) && (weightCargo2 <= WEIGHT_MAX_AVERAGE) &&
    ...
    println("Груз2 с весом $weightCargo2 кг и объемом $volumeCargo2 л соответствует категории 'Average':$correspondence1")
